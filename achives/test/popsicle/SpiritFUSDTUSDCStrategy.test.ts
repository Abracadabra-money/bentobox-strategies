...
const degenBox = Constants.fantom.limone;
const spiritToken = Constants.fantom.spiritswap.spîrit;
const gauge = Constants.fantom.spiritswap.gaugeProxy;
const pair = Constants.fantom.spiritswap.fUSDTUSDC;
const pairWhale = "0x3a0cA7dBe248eF8Ce5Ed2237cE85C7aE6036513A";

describe("SpiritSwap FUSDT/USDC LP Strategy", async () => {
  let snapshotId;
      ...
      params: [
        {
          forking: {
            ...
            blockNumber: 39028168,
          },
        },
      ],
    });

    await deployments.fixture(["LimoneSpiritFUSDTUSDCStrategy"]);
